...
public static class IdentityModuleExtensions
{
    ...
    /// defaults only work for local development on localhost, including the
    /// default Kestrel URLs (http://localhost:5000 and https://localhost:5001).
    /// WebAuthn compares the full origin, so scheme and port must match. Any
