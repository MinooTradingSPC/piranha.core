...
Vue.component("html-block", {
  ...
  data: function () {
    return {
      body: DOMPurify.sanitize(this.model.body.value || '', {
        USE_PROFILES: {
          html: true
        }
      })
...
Vue.component("html-column-block", {
  ...
  data: function () {
    return {
      column1: DOMPurify.sanitize(this.model.column1.value || '', {
        USE_PROFILES: {
          html: true
        }
      }),
      column2: DOMPurify.sanitize(this.model.column2.value || '', {
        USE_PROFILES: {
          html: true
        }
      })
...
Vue.component("quote-block", {
  ...
  created: function () {
    if (this.model.body.value) {
      this.model.body.value = DOMPurify.sanitize(this.model.body.value, {
        USE_PROFILES: {
          html: true
        }
      });
    ...
    if (this.model.author.value) {
      this.model.author.value = DOMPurify.sanitize(this.model.author.value, {
        USE_PROFILES: {
          html: true
        }
      });
...
Vue.component("html-field", {
  ...
  data: function () {
    return {
      body: DOMPurify.sanitize(this.model.value || '', {
        USE_PROFILES: {
          html: true
        }
      })
  ...
  template: "\n    <div class=\"field htms-field\" :class=\"{ empty: isEmpty }\">\n        <div contenteditable=\"true\" :id=\"uid\" v-html=\"body\" v-on:blur=\"onBlur\"></div>\n    </div>\n"
});
