    ...
    methods: {
        ...
        saveInternal: function (route) {
            ...
            var model = {
                ...
                slug: self.slug,
                metaTitle: DOMPurify.sanitize(self.metaTitle, {USE_PROFILES: {html: false}} ),
                metaKeywords: DOMPurify.sanitize(self.metaKeywords, {USE_PROFILES: {html: false}} ),
                metaDescription: DOMPurify.sanitize(self.metaDescription, {USE_PROFILES: {html: false}} ),
                metaIndex: self.metaIndex,
                metaFollow: self.metaFollow,
                metaPriority: self.metaPriority,
                ogTitle: DOMPurify.sanitize(self.ogTitle, {USE_PROFILES: {html: false}} ),
                ogDescription: DOMPurify.sanitize(self.ogDescription, {USE_PROFILES: {html: false}} ),
                ogImage: {
                    id: self.ogImage.id
                },
